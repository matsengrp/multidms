...
class ModelCollection:
    ...
    def __init__(self, fit_models):
        ...
        fit_models["final_loss"] = fit_models.step_loss.apply(lambda x: x[-1])
    ...
    #     ):
    #     """
    #     Vertically concatenate the variants_df's for each fit in the collection,
    #     and add the specified features to the resulting dataframe.
    #     """
    #     variants_df = pd.concat(
    #         [
    #             row.model.get_variants_df(**kwargs)
    #             .assign(

    #             )
    #             for idx, row in self.fit_models.iterrows()
    #         ]
    #     )
    #     variants_df.head()
